...
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField TO_FIELD_DESC = new org.apache.thrift.protocol.TField("to", org.apache.thrift.protocol.TType.STRING, (short)5);
  ...
  private _Fields optionals[] = {_Fields.ID,_Fields.SUBJECT,_Fields.LABEL,_Fields.FROM,_Fields.TO,_Fields.SEND_TIME};
